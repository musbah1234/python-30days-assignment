...
sorted_countries_by_population = sorted(countries, key=lambda x: x["population"])

# Get the ten most spoken languages across all countries
all_languages = [language for country in countries for language in country["languages"]]
top_ten_spoken_languages = sorted(set(all_languages), key=lambda x: all_languages.count(x), reverse=True)[:10]

# Get the ten most populated countries
top_ten_populated_countries = sorted(countries, key=lambda x: x["population"], reverse=True)[:10]

# Print or use the results as needed
print("Sorted by Name:", sorted_countries_by_name)
print("Sorted by Capital:", sorted_countries_by_capital)
print("Sorted by Population:", sorted_countries_by_population)
print("Top Ten Spoken Languages:", top_ten_spoken_languages)
print("Top Ten Populated Countries:", top_ten_populated_countries)
